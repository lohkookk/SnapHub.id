...
const FloatingWhatsapp = () => (
  <motion.a
    ...
    transition={{ delay: 2.2, duration: 0.55, type: 'spring', stiffness: 260, damping: 20 }}
    whileHover={{ scale: 1.12 }}
    whileTap={{ scale: 0.9 }}
    className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center wa-pulse"
    style={{
      background: 'linear-gradient(135deg, #25D366, #128C7E)',
      boxShadow: '0 4px 24px rgba(37,211,102,0.5), 0 2px 8px rgba(0,0,0,0.3)',
    }}
  >
    {/* Outer ripple ring */}
    <motion.span
